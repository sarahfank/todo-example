...
class ToDoListSelector extends Component {
  ...
  getLists = () => {
    client.getLists().then(userLists => {
      this.setState({
  ...
  createList = () => {
    client.createList(this.state.createListName).then(() => {
      this.getLists()
  ...
  render() {
    return (
      <div>
        ...
        <div>
          <ul className="lists">{this.renderListNames()}</ul>
          <div className="create-list">
            ...
            />
            <button className="create-list-button" onClick={this.createList}>
              Create List
            </button>
          </div>
        </div>
